...
Подготовьте слайды по эксперименту: 1) название статьи и постановка задачи (по статье) 2) использованные данные 3) постановка эксперимента 4) таблица с результатами 
